            ...
            {scanMode && productStocks && productStocks.length > 0 && (
              <div className="flex items-center gap-2 p-3 rounded-md bg-blue-50 border-2 border-blue-400 text-sm">
                ...
                <span className="text-blue-800">
                  已在 <b className="font-bold">{productStocks.length}</b> 个库位有库存
                  {selectedLocation && (
                    <>
                      ，已选最近库位：
                      ...
                      {filteredLocations.map((l) => {
                        ...
                        return (
                          <button
                            ...
                            className={`flex w-full items-center justify-between px-3 py-3 text-sm transition-colors border-l-4 ${
                              stock
