...
function createSlottable(ownerName) {
  const Slottable2 = __name5((props) => "child" in props ? props.children(props.child) : props.children, "Slottable");
...
var getSlottableElementFromSlottable = __name5((slottable, child) => {
...
var createSlotError = __name5((ownerName) => {
  return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
}, "createSlotError");
var createSlottableError = __name5((ownerName) => {
...
var DismissableLayerBranch = React8.forwardRef(__name10(function DismissableLayerBranch2(props, forwardedRef) {
  const context = React8.useContext(DismissableLayerContext);
...
var FocusScope = React10.forwardRef(
  __name12(function FocusScope2(props, forwardedRef) {
    const {
      loop = false,
      trapped = false,
...
var Arrow = React14.forwardRef(
  __name14(function Arrow2(props, forwardedRef) {
...
var PopperAnchor = React16.forwardRef(
  __name16(function PopperAnchor2(props, forwardedRef) {
...
var PopperContent = React16.forwardRef(
  __name16(function PopperContent2(props, forwardedRef) {
    ...
    const { refs, floatingStyles, placement, isPositioned, middlewareData } = useFloating({
      ...
      whileElementsMounted: __name16((...args) => {
      ...
      middleware: [
        ...
        size3({
          ...detectOverflowOptions,
          apply: __name16(({ elements, rects, availableWidth, availableHeight }) => {
...
var PopperArrow = React16.forwardRef(
  __name16(function PopperArrow2(props, forwardedRef) {
...
var transformOrigin = __name16((options) => ({
...
var Portal = React17.forwardRef(
  __name17(function Portal2(props, forwardedRef) {
    var _a2;
...
function usePresence(present) {
  ...
  useLayoutEffect2(() => {
    if (node) {
      ...
      const handleAnimationEnd = __name18((event) => {
      ...
      const handleAnimationStart = __name18((event) => {
...
__name19(useEffectEvent, "useEffectEvent");
...
__name20(useControllableState, "useControllableState");
...
__name20(useUncontrolledState, "useUncontrolledState");
function isFunction(value) {
  return typeof value === "function";
}
__name20(isFunction, "isFunction");
...
__name20(useControllableStateReducer, "useControllableStateReducer");
...
__name21(usePrevious, "usePrevious");
...
var VisuallyHidden = React25.forwardRef(
  __name22(function VisuallyHidden2(props, forwardedRef) {
...
function SelectProvider(props) {
  ...
  const initialValueRef = React35.useRef(value);
  React35.useEffect(() => {
    ...
    if (associatedForm instanceof HTMLFormElement) {
      const reset = __name23(() => setValue(initialValueRef.current), "reset");
  ...
  const handleNativeOptionAdd = React35.useCallback((option) => {
    setNativeOptionsSet((prev) => new Set(prev).add(option));
  }, []);
  const handleNativeOptionRemove = React35.useCallback((option) => {
...
__name23(SelectProvider, "SelectProvider");
var Select = __name23((props) => {
...
var SelectTrigger = React35.forwardRef(
  __name23(function SelectTrigger2(props, forwardedRef) {
    ...
    const handleOpen = __name23((pointerEvent) => {
      if (!isDisabled) {
...
var SelectValue = React35.forwardRef(
  __name23(function SelectValue2(props, forwardedRef) {
    ...
    return (0, import_jsx_runtime12.jsx)(
      Primitive.span,
      {
        ...
        children: (0, import_jsx_runtime12.jsx)(React35.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }, "SelectValue")
);
var SelectIcon = React35.forwardRef(
  __name23(function SelectIcon2(props, forwardedRef) {
...
var SelectPortal = __name23((props) => {
...
var SelectContent = React35.forwardRef(
  __name23(function SelectContent2(props, forwardedRef) {
...
var SelectContentFragment = React35.forwardRef(__name23(function SelectContentFragment2(props, forwardedRef) {
...
var SelectContentImpl = React35.forwardRef(
  // blank line to reduce diff noise
  __name23(function SelectContentImpl2(props, forwardedRef) {
    ...
    React35.useEffect(() => {
      if (content) {
        ...
        const handlePointerMove = __name23((event) => {
          var _a2, _b;
          pointerMoveDelta = {
        ...
        const handlePointerUp = __name23((event) => {
    ...
    React35.useEffect(() => {
      const close = __name23(() => onOpenChange(false), "close");
...
var SelectItemAlignedPosition = React35.forwardRef(__name23(function SelectItemAlignedPosition2(props, forwardedRef) {
...
var SelectPopperPosition = React35.forwardRef(__name23(function SelectPopperPosition2(props, forwardedRef) {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React35.forwardRef(
  __name23(function SelectViewport2(props, forwardedRef) {
...
var SelectGroup = React35.forwardRef(
  __name23(function SelectGroup2(props, forwardedRef) {
...
var SelectLabel = React35.forwardRef(
  __name23(function SelectLabel2(props, forwardedRef) {
...
var SelectItem = React35.forwardRef(
  __name23(function SelectItem2(props, forwardedRef) {
    const {
      __scopeSelect,
      value,
      disabled = false,
...
var SelectItemText = React35.forwardRef(
  __name23(function SelectItemText2(props, forwardedRef) {
...
var SelectItemIndicator = React35.forwardRef(
  // blank line to reduce diff noise
  __name23(function SelectItemIndicator2(props, forwardedRef) {
...
var SelectScrollUpButton = React35.forwardRef(__name23(function SelectScrollUpButton2(props, forwardedRef) {
  ...
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      ...
      __name23(handleScroll22, "handleScroll");
...
var SelectScrollDownButton = React35.forwardRef(__name23(function SelectScrollDownButton2(props, forwardedRef) {
...
var SelectScrollButtonImpl = React35.forwardRef(__name23(function SelectScrollButtonImpl2(props, forwardedRef) {
...
var SelectSeparator = React35.forwardRef(
  // blank line to reduce diff noise
  __name23(function SelectSeparator2(props, forwardedRef) {
...
var SelectArrow = React35.forwardRef(
  __name23(function SelectArrow2(props, forwardedRef) {
    const { __scopeSelect, ...arrowProps } = props;
    const popperScope = usePopperScope(__scopeSelect);
    const contentContext = useSelectContentContext(ARROW_NAME2, __scopeSelect);
    return contentContext.position === "popper" ? (0, import_jsx_runtime12.jsx)(Arrow3, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }, "SelectArrow")
);
var BUBBLE_INPUT_NAME = "SelectBubbleInput";
var SelectBubbleInput = React35.forwardRef(
  // blank line to reduce diff noise
  __name23(function SelectBubbleInput2({ __scopeSelect, ...props }, forwardedRef) {
...
__name23(shouldShowPlaceholder, "shouldShowPlaceholder");
function useTypeaheadSearch(onSearchChange) {
  ...
  const handleTypeaheadSearch = React35.useCallback(
    (key) => {
      ...
      __name23((function updateSearch(value) {
...
__name23(useTypeaheadSearch, "useTypeaheadSearch");
...
__name23(findNextItem, "findNextItem");
